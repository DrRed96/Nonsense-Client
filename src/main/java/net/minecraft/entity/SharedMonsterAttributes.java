...
public class SharedMonsterAttributes
{
    ...
    public static final IAttribute movementSpeed = (new RangedAttribute(null, "generic.movementSpeed", 0.7D, 0.0D, 1024.0D)).setDescription("Movement Speed").setShouldWatch(true);
