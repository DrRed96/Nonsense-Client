...
public class Achievement extends StatBase {
    ...
    public Achievement(String statId, String unlocalizedName, int column, int row, Item item, Achievement parent) {
        this(statId, unlocalizedName, column, row, new ItemStack(item), parent);
    }

    public Achievement(String statId, String unlocalizedName, int column, int row, Block block, Achievement parent) {
        this(statId, unlocalizedName, column, row, new ItemStack(block), parent);
    }

    public Achievement(String statId, String unlocalizedName, int column, int row, ItemStack itemStack, Achievement parent) {
        super(statId, new ChatComponentTranslation("achievement." + unlocalizedName));
     ...
     */
    public Achievement setStatStringFormatter(IStatStringFormat format) {
        this.statStringFormatter = format;
        return this;
    }
