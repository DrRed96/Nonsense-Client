...
{
    private static final byte[] emptySector = new byte[0x1000];
    private final File fileName;
    private RandomAccessFile dataFile;
    private final int[] offsets = new int[0x400];
    private final int[] chunkTimestamps = new int[0x400];
    ...
    public RegionFile(File fileNameIn)
    {
        ...
        try
        {
            ...
            if (this.dataFile.length() < 0x1000L)
            {
            ...
            {
                for (int j1 = 0; (long)j1 < (this.dataFile.length() & 0xfffL); ++j1)
                {
                    this.dataFile.write(0);
                }
            }

            int k1 = (int)this.dataFile.length() / 0x1000;
    ...
    {
        this.dataFile.seek(sectorNumber * 0x1000L);
