...
public enum EnumConnectionState {
    ...
    private static final EnumConnectionState[] STATES_BY_ID = new EnumConnectionState[MAX_ID - MIN_ID + 1];
    ...
    public static EnumConnectionState getById(int stateId) {
        return stateId >= MIN_ID && stateId <= MAX_ID ? STATES_BY_ID[stateId - MIN_ID] : null;
    }
    ...
    static {
        for (EnumConnectionState enumconnectionstate : values()) {
            ...
            STATES_BY_ID[i - MIN_ID] = enumconnectionstate;
