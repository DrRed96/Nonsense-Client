...
public class LoadingScreenRenderer implements IProgressUpdate
{
    ...
    public LoadingScreenRenderer(Minecraft mcIn)
    {
        ...
        this.framebuffer.setFramebufferFilter(GL_NEAREST);
    }
        ...
        else
        {
            ...
            if (i - this.systemTime >= 100L)
            {
                ...
                if (progress >= 0)
                {
                    ...
                    worldrenderer.pos(x, y, 0.0D).color(128, 128, 128, 255).endVertex();
                    worldrenderer.pos(x, y + j1, 0.0D).color(128, 128, 128, 255).endVertex();
                    worldrenderer.pos(x + i1, y + j1, 0.0D).color(128, 128, 128, 255).endVertex();
                    worldrenderer.pos(x + i1, y, 0.0D).color(128, 128, 128, 255).endVertex();
                    worldrenderer.pos(x, y, 0.0D).color(128, 255, 128, 255).endVertex();
                    worldrenderer.pos(x, y + j1, 0.0D).color(128, 255, 128, 255).endVertex();
                    worldrenderer.pos(x + progress, y + j1, 0.0D).color(128, 255, 128, 255).endVertex();
                    worldrenderer.pos(x + progress, y, 0.0D).color(128, 255, 128, 255).endVertex();
                    tessellator.draw();
