...
import wtf.bhopper.nonsense.component.impl.packet.InventoryExploitComponent;
...
public abstract class GuiContainer extends GuiScreen {
    ...
    private GuiButton auraButton = null;
    private GuiButton invButton = null;
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.auraButton = new GuiButton(2001, 2, 2, "Disable Kill Aura"));
        this.buttonList.add(this.invButton = new GuiButton(2002, 2, 24, "Disable Inventory Manager"));

        this.buttonList.add(new GuiButton(3001, 2, 68, "Close Without Packet"));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.auraButton != null) {
            this.auraButton.enabled = Nonsense.module(KillAura.class).isToggled();
        }

        if (this.invButton != null) {
            this.invButton.enabled = Nonsense.module(InventoryManager.class).isToggled();
        }
