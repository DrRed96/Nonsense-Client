...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    public static GuiScreen newInstance(EntityPlayer player) {
        return custom ? new GuiCustomCreative(player) : new GuiContainerCreative(player);
    }
    ...
    public void initGui()
    {
        if (this.mc.playerController.isInCreativeMode())
        {
            ...
            this.buttonList.add(new GuiButton(69, this.guiLeft, this.guiTop - 50, 100, 20, "Tabs: \247aMinecraft"));
        }
        else
        {
            this.mc.displayGuiScreen(new GuiInventory(this.mc.thePlayer));
