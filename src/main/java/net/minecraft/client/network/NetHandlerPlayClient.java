...
import wtf.bhopper.nonsense.event.impl.packet.EventTeleport;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public NetHandlerPlayClient(Minecraft mcIn, GuiScreen guiScreenServer, NetworkManager netManager, GameProfile profile) {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        Nonsense.getEventBus().post(new EventJoinGame());
    }
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        EventTeleport event = new EventTeleport(new C03PacketPlayer.C06PacketPlayerPosLook(entityplayer.posX, entityplayer.posY, entityplayer.posZ, entityplayer.rotationYaw, entityplayer.rotationPitch, false),
                x,
                y,
                z,
                yaw,
        ...
        this.netManager.sendPacket(new C03PacketPlayer.C06PacketPlayerPosLook(x, y, z, yaw, pitch, false));
    ...
    public void handleRespawn(S07PacketRespawn packetIn) {
        ...
        if (packetIn.getDimensionID() != this.gameController.thePlayer.dimension) {
            ...
            this.clientWorldController = new WorldClient(this, new WorldSettings(0L, packetIn.getGameType(), false, this.gameController.theWorld.getWorldInfo().isHardcoreModeEnabled(), packetIn.getWorldType()), packetIn.getDimensionID(), packetIn.getDifficulty());
    ...
    public void handlePlayerListItem(S38PacketPlayerListItem packetIn) {
        ...
        for (S38PacketPlayerListItem.AddPlayerData playerData : packetIn.getPlayers()) {
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        ...
        if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            this.gameController.thePlayer.setClientBrand(packetIn.getBufferData().readStringFromBuffer(0x7fff));
