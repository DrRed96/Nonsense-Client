...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            Nonsense.getEventBus().post(new EventUpdate());
    ...
    public void onUpdateWalkingPlayer() {
        ...
        Nonsense.getEventBus().post(new EventPostMotion(event));
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            ...
            if (!eventSlowDown.isCancelled()) {
                this.movementInput.moveStrafe *= eventSlowDown.factor;
                this.movementInput.moveForward *= eventSlowDown.factor;
        ...
        if (!this.isSprinting() && this.movementInput.moveForward >= f && flag3 && !Nonsense.module(NoSlow.class).usingItemFixed() && !this.isPotionActive(Potion.blindness) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
            this.setSprinting(true);
        }
