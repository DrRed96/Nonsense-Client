...
public class ItemRenderer {
    ...
    private void renderPlayerArm(AbstractClientPlayer clientPlayer, float p_178095_2_, float p_178095_3_) {
        ...
        GlStateManager.translate(f, f1, f2);
        GlStateManager.translate(0.64F, -0.6F, -0.72F);
    ...
    public void doSwingTransformations(float p_178105_1_) {
    ...
    public void doEatTransformations(AbstractClientPlayer clientPlayer, float p_178104_2_) {
    ...
    public void doBowTransformations(float p_178098_1_, AbstractClientPlayer clientPlayer) {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                ItemAnimations module = Nonsense.module(ItemAnimations.class);
                if (module.isToggled()) {
                    module.renderItem(this, player, this.itemToRender, equipProgress, swingProgress, partialTicks);
                    ...
                    if (player.getItemInUseCount() > 0) {
                        ...
                        switch (this.itemToRender.getItemUseAction()) {
                            ...
                            case EAT, DRINK -> {
                                this.doEatTransformations(player, partialTicks);
                        ...
                        this.doSwingTransformations(swingProgress);
