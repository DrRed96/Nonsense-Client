...
public class TextureMap extends AbstractTexture implements ITickableTextureObject {
    ...
    public void loadTextureAtlas(IResourceManager resourceManager) {
        ...
        for (final TextureAtlasSprite textureatlassprite20 : this.mapRegisteredSprites.values()) {

            try {
                textureatlassprite20.generateMipmaps(this.mipmapLevels);
            } catch (Throwable throwable1) {
                CrashReport crashreport = CrashReport.makeCrashReport(throwable1, "Applying mipmap");
                CrashReportCategory crashreportcategory = crashreport.makeCategory("Sprite being mipmapped");
                crashreportcategory.addCrashSectionCallable("Sprite name", textureatlassprite20::getIconName);
                crashreportcategory.addCrashSectionCallable("Sprite size", () -> textureatlassprite20.getIconWidth() + " x " + textureatlassprite20.getIconHeight());
                crashreportcategory.addCrashSectionCallable("Sprite frames", () -> textureatlassprite20.getFrameCount() + " frames");
        ...
        HashMap<String, TextureAtlasSprite> hashmap = Maps.newHashMap(this.mapRegisteredSprites);

        for (TextureAtlasSprite textureatlassprite30 : stitcher.getStichSlots()) {
            String s = textureatlassprite30.getIconName();
            hashmap.remove(s);
            this.mapUploadedSprites.put(s, textureatlassprite30);

            try {
                TextureUtil.uploadTextureMipmap(textureatlassprite30.getFrameTextureData(0), textureatlassprite30.getIconWidth(), textureatlassprite30.getIconHeight(), textureatlassprite30.getOriginX(), textureatlassprite30.getOriginY(), false, false);
                ...
                crashreportcategory1.addCrashSection("Sprite", textureatlassprite30);
                throw new ReportedException(crashreport1);
            }

            if (textureatlassprite30.hasAnimationMetadata()) {
                this.listAnimatedSprites.add(textureatlassprite30);
            }
        }
        ...
        if (Config.isMultiTexture()) {
            ...
            for (TextureAtlasSprite textureatlassprite50 : stitcher.getStichSlots()) {
                TextureAtlasSprite textureatlassprite5 = textureatlassprite50;
    ...
    public ResourceLocation completeResourceLocation(ResourceLocation location, int p_147634_2_) {
        return this.isAbsoluteLocation(location) ? (p_147634_2_ == 0 ? new ResourceLocation(location.getResourceDomain(), location.getResourcePath() + ".png") : new ResourceLocation(location.getResourceDomain(), location.getResourcePath() + "mipmap" + p_147634_2_ + ".png")) : (p_147634_2_ == 0 ? new ResourceLocation(location.getResourceDomain(), String.format("%s/%s%s", this.basePath, location.getResourcePath(), ".png")) : new ResourceLocation(location.getResourceDomain(), String.format("%s/mipmaps/%s.%d%s", this.basePath, location.getResourcePath(), Integer.valueOf(p_147634_2_), ".png")));
    }
    ...
    public void updateAnimations() {
        ...
        if (Config.isMultiTexture()) {
            for (TextureAtlasSprite textureatlassprite10 : this.listAnimatedSprites) {
                ...
                if (this.isTerrainAnimationActive(textureatlassprite10)) {
                    TextureAtlasSprite textureatlassprite2 = textureatlassprite10.spriteSingle;

                    if (textureatlassprite2 != null) {
                        if (textureatlassprite10 == TextureUtils.iconClock || textureatlassprite10 == TextureUtils.iconCompass) {
                            textureatlassprite2.frameCounter = textureatlassprite10.frameCounter;
                        }
        ...
        if (Config.isShaders()) {
            if (flag) {
                ...
                for (TextureAtlasSprite textureatlassprite30 : this.listAnimatedSprites) {

                    if (textureatlassprite30.spriteNormal != null && this.isTerrainAnimationActive(textureatlassprite30)) {
                        if (textureatlassprite30 == TextureUtils.iconClock || textureatlassprite30 == TextureUtils.iconCompass) {
                            textureatlassprite30.spriteNormal.frameCounter = textureatlassprite30.frameCounter;
                        }

                        textureatlassprite30.spriteNormal.updateAnimation();
                    }
                }
            }
    ...
    private void updateIconGrid(int p_updateIconGrid_1_, int p_updateIconGrid_2_) {
        ...
        if (this.iconGridSize > 0) {
            ...
            for (TextureAtlasSprite textureatlassprite0 : this.mapUploadedSprites.values()) {
                double d0 = 0.5D / (double) p_updateIconGrid_1_;
                double d1 = 0.5D / (double) p_updateIconGrid_2_;
                double d2 = (double) Math.min(textureatlassprite0.getMinU(), textureatlassprite0.getMaxU()) + d0;
                double d3 = (double) Math.min(textureatlassprite0.getMinV(), textureatlassprite0.getMaxV()) + d1;
                double d4 = (double) Math.max(textureatlassprite0.getMinU(), textureatlassprite0.getMaxU()) - d0;
                double d5 = (double) Math.max(textureatlassprite0.getMinV(), textureatlassprite0.getMaxV()) - d1;
                    ...
                    if (i1 >= 0 && i1 < this.iconGridCountX) {
                        for (int j1 = j; j1 <= l; ++j1) {
                            if (j1 >= 0 && j1 < this.iconGridCountX) {
                                ...
                                this.iconGrid[k1] = textureatlassprite0;
                            } else {
                                Config.warn("Invalid grid V: " + j1 + ", icon: " + textureatlassprite0.getIconName());
                            }
                        }
                    } else {
                        Config.warn("Invalid grid U: " + i1 + ", icon: " + textureatlassprite0.getIconName());
                    }
                }
            }
        }
