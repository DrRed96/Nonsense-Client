...
public class GuiConnecting extends GuiScreen {
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
            public void run() {
                ...
                try {
                    ...
                    GuiConnecting.this.networkManager = NetworkManager.connect(inetaddress, port, GuiConnecting.this.mc.gameSettings.func_181148_f());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.networkManager == null) {
            this.drawCenteredString(this.fontRendererObj, I18n.format("connect.connecting"), this.width / 2, this.height / 2 - 50, 0xffffff);
        } else {
