...
public class SimpleReloadableResourceManager implements IReloadableResourceManager {
    ...
    public void reloadResourcePack(IResourcePack resourcePack) {
        for (String domain : resourcePack.getResourceDomains()) {
            this.setResourceDomains.add(domain);
            FallbackResourceManager fallbackresourcemanager = this.domainResourceManagers.get(domain);

            if (fallbackresourcemanager == null) {
                fallbackresourcemanager = new FallbackResourceManager(this.rmMetadataSerializer);
                this.domainResourceManagers.put(domain, fallbackresourcemanager);
            }
