...
public class Item {
    ...
    public static void registerItems() {
        // This way is so aids...
        // - Calculus
        registerItemBlock(Blocks.stone, (new ItemMultiTexture(Blocks.stone, Blocks.stone, itemStack -> BlockStone.EnumType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("stone"));
        registerItemBlock(Blocks.grass, new ItemColored(Blocks.grass, false));
        registerItemBlock(Blocks.dirt, (new ItemMultiTexture(Blocks.dirt, Blocks.dirt, itemStack -> BlockDirt.DirtType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("dirt"));
        registerItemBlock(Blocks.cobblestone);
        registerItemBlock(Blocks.planks, (new ItemMultiTexture(Blocks.planks, Blocks.planks, itemStack -> BlockPlanks.EnumType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("wood"));
        registerItemBlock(Blocks.sapling, (new ItemMultiTexture(Blocks.sapling, Blocks.sapling, itemStack -> BlockPlanks.EnumType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("sapling"));
        registerItemBlock(Blocks.bedrock);
        registerItemBlock(Blocks.sand, (new ItemMultiTexture(Blocks.sand, Blocks.sand, itemStack -> BlockSand.EnumType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("sand"));
        ...
        registerItemBlock(Blocks.log, (new ItemMultiTexture(Blocks.log, Blocks.log, itemStack -> BlockPlanks.EnumType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("log"));
        registerItemBlock(Blocks.log2, (new ItemMultiTexture(Blocks.log2, Blocks.log2, itemStack -> BlockPlanks.EnumType.byMetadata(itemStack.getMetadata() + 4).getUnlocalizedName())).setUnlocalizedName("log"));
        ...
        registerItemBlock(Blocks.yellow_flower, (new ItemMultiTexture(Blocks.yellow_flower, Blocks.yellow_flower, itemStack -> BlockFlower.EnumFlowerType.getType(BlockFlower.EnumFlowerColor.YELLOW, itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("flower"));
        registerItemBlock(Blocks.red_flower, (new ItemMultiTexture(Blocks.red_flower, Blocks.red_flower, itemStack -> BlockFlower.EnumFlowerType.getType(BlockFlower.EnumFlowerColor.RED, itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("rose"));
        ...
        registerItemBlock(Blocks.monster_egg, (new ItemMultiTexture(Blocks.monster_egg, Blocks.monster_egg, itemStack -> BlockSilverfish.EnumType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("monsterStoneEgg"));
        registerItemBlock(Blocks.stonebrick, (new ItemMultiTexture(Blocks.stonebrick, Blocks.stonebrick, itemstack -> BlockStoneBrick.EnumType.byMetadata(itemstack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("stonebricksmooth"));
        ...
        registerItemBlock(Blocks.double_plant, (new ItemDoublePlant(Blocks.double_plant, Blocks.double_plant, itemStack -> BlockDoublePlant.EnumPlantType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("doublePlant"));
        ...
        registerItemBlock(Blocks.prismarine, (new ItemMultiTexture(Blocks.prismarine, Blocks.prismarine, itemStack -> BlockPrismarine.EnumType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("prismarine"));
        registerItemBlock(Blocks.sea_lantern);
        registerItemBlock(Blocks.red_sandstone, (new ItemMultiTexture(Blocks.red_sandstone, Blocks.red_sandstone, itemStack -> BlockRedSandstone.EnumType.byMetadata(itemStack.getMetadata()).getUnlocalizedName())).setUnlocalizedName("redSandStone"));
