...
public class GuiCustomCreative extends InventoryEffectRenderer {
    ...
    {
        super(new GuiCustomCreative.ContainerCreative(player));
    ...
    public void initGui()
    {
        if (this.mc.playerController.isInCreativeMode())
        {
            ...
            this.buttonList.add(new GuiButton(69, this.guiLeft, this.guiTop - 50, 100, 20, "Tabs: \247cNonsense"));
        }
        else
        {
            this.mc.displayGuiScreen(new GuiInventory(this.mc.thePlayer));
    ...
    {
        if (selectedTabIndex != CustomCreativeTabs.tabAllSearch.getTabIndex())
        {
            if (GameSettings.isKeyDown(this.mc.gameSettings.keyBindChat))
            {
                this.setCurrentCreativeTab(CustomCreativeTabs.tabAllSearch);
            }
            else
            {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        if (creativetabs.drawInForegroundOfTab())
        {
            ...
            this.fontRendererObj.drawString(I18n.format(creativetabs.getTranslatedTabLabel()), 8, 6, 0x404040);
        }
    }
    ...
    private void setCurrentCreativeTab(CreativeTabs p_147050_1_)
    {
        ...
        if (p_147050_1_ == CustomCreativeTabs.tabInventory)
        {
        ...
        {
            if (p_147050_1_ == CustomCreativeTabs.tabAllSearch)
            {
