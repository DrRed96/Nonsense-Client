...
public class PlayerData implements IMinecraft {
    ...
    public void handleRelMove(S14PacketEntity packetEntity) {
        ...
        double d0 = (double) (this.entity.serverPosX + packetEntity.getX()) / 32.0D;
        double d1 = (double) (this.entity.serverPosY + packetEntity.getY()) / 32.0D;
        double d2 = (double) (this.entity.serverPosZ + packetEntity.getZ()) / 32.0D;
        float f = packetEntity.isRotating() ? (float) (packetEntity.getYaw() * 360) / 256.0F : this.rotationYaw;
        float f1 = packetEntity.isRotating() ? (float) (packetEntity.getPitch() * 360) / 256.0F : this.rotationPitch;

        this.updatePosition(d0, d1, d2);
        this.updateRotation(f, f1);
    ...
    public void handleTeleport(S18PacketEntityTeleport packetEntityTeleport) {
        ...
        double d0 = (double) packetEntityTeleport.getX() / 32.0D;
        double d1 = (double) packetEntityTeleport.getY() / 32.0D;
        double d2 = (double) packetEntityTeleport.getZ() / 32.0D;
        float f = (float) (packetEntityTeleport.getYaw() * 360) / 256.0F;
        float f1 = (float) (packetEntityTeleport.getPitch() * 360) / 256.0F;
