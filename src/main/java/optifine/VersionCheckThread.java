    ...
    public void run() {
        ...
        try {
            ...
            if (Config.getGameSettings().snooperEnabled) {
                httpurlconnection.setRequestProperty("OF-MC-Version", Config.MC_VERSION);
                httpurlconnection.setRequestProperty("OF-MC-Brand", "" + ClientBrandRetriever.getClientModName());
                httpurlconnection.setRequestProperty("OF-Edition", Config.OF_EDITION);
                httpurlconnection.setRequestProperty("OF-Release", Config.OF_RELEASE);
